...
static int uio_pdrv_hm2adc_io_probe(struct platform_device *pdev)
{
...
static int uio_pdrv_hm2adc_io_remove(struct platform_device *pdev)
{
...
static struct platform_driver hm2adc_uio = {
    .probe = uio_pdrv_hm2adc_io_probe,
    .remove = uio_pdrv_hm2adc_io_remove,
    .driver = {
        .name = DRIVER_NAME,
        .owner = THIS_MODULE,
