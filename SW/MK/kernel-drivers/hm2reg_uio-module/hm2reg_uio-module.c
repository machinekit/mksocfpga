...
static int uio_pdrv_hm2reg_io_probe(struct platform_device *pdev)
{
...
static struct platform_driver hm2reg_uio = {
    .probe = uio_pdrv_hm2reg_io_probe,
    .remove = uio_pdrv_hm2reg_io_remove,
    .driver = {
        .name = DRIVER_NAME,
        .owner = THIS_MODULE,
...
module_platform_driver(hm2reg_uio);
