...
sudo cp -f $SCRIPT_ROOT_DIR/mk-sid-rip-build.sh $ROOTFS_MNT/home/
...
set -x
hostnamectl set-hostname mksocfpga

/home/mk-sid-rip-build.sh
...
hostnamectl set-hostname debian9-ws
