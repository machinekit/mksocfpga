...
#
# ultramyir_xczu3eg.tcl: Tcl script for re-creating project 'ultramyir_xczu3eg'
#
# Generated by Vivado on Fri Jun 25 19:29:55 +0200 2021
...
#
# 1. This project restoration tcl script (ultramyir_xczu3eg.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/work/HW/VivadoProjects/myirtech/ultramyir/ultramyir_xczu3eg_created/ultramyir_xczu3eg.srcs/sources_1/imports/ultramyir_xczu3eg_created/ultramyir_xczu3eg.srcs/sources_1/bd/soc_system/hdl/soc_system_wrapper.vhd"
#    "/work/HW/VivadoProjects/myirtech/ultramyir/ultramyir_xczu3eg_created/ultramyir_xczu3eg.srcs/sources_1/imports/ultramyir_xczu3eg_created/firmware_id.mif"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/work/HW/VivadoProjects/myirtech/ultramyir/const/ultramyir_pinmap.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  ...
  set paths [list \
   [file normalize "$origin_dir/../../../zynq-ip"] \
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "ultramyir_xczu3eg"
...
set script_file "ultramyir_xczu3eg.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/ultramyir_xczu3eg_created"]"
...
set files [list \
 [file normalize "${origin_dir}/ultramyir_xczu3eg_created/ultramyir_xczu3eg.srcs/sources_1/imports/ultramyir_xczu3eg_created/ultramyir_xczu3eg.srcs/sources_1/bd/soc_system/hdl/soc_system_wrapper.vhd"]\
 [file normalize "${origin_dir}/ultramyir_xczu3eg_created/ultramyir_xczu3eg.srcs/sources_1/imports/ultramyir_xczu3eg_created/firmware_id.mif"]\
]
...
set file "ultramyir_xczu3eg_created/firmware_id.mif"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
set file "[file normalize "$origin_dir/const/ultramyir_pinmap.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/const/ultramyir_pinmap.xdc"
...
# Proc to create BD soc_system
proc cr_bd_soc_system { parentCell } {
  ...
  assign_bd_address -offset 0xA0040000 -range 0x00040000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_1/Data] [get_bd_addr_segs hm2_axilite_int_0/S_AXI/reg0] -force
...
# End of cr_bd_soc_system()
cr_bd_soc_system ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files soc_system.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "0" [get_files soc_system.bd ] 
set_property IS_ENABLED "1" [get_files soc_system.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files soc_system.bd ] 
set_property IS_LOCKED "0" [get_files soc_system.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files soc_system.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files soc_system.bd ] 
set_property PFM_NAME "" [get_files soc_system.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files soc_system.bd ] 
set_property SYNTH_CHECKPOINT_MODE "None" [get_files soc_system.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files soc_system.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files soc_system.bd ] 
set_property USED_IN_SIMULATION "1" [get_files soc_system.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files soc_system.bd ] 
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/ultramyir_xczu3eg.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/ultramyir_xczu3eg.srcs/utils_1/imports/impl_1" -objects $obj
