...
proc create_root_design { parentCell } {
  ...
  set RATES [ create_bd_port -dir O -from 2 -to 0 RATES ]
  ...
  # Create instance: rst_ps8_1_99M, and set properties
  set rst_ps8_1_99M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps8_1_99M ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#CAN 1#CAN 1#GPIO1 MIO#DPAUX#DPAUX#DPAUX#DPAUX#PCIE#I2C 1#I2C 1#UART 0#UART 0#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#I2C 0#I2C 0#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
   ...
   CONFIG.PSU__CRL_APB__PL0_REF_CTRL__ACT_FREQMHZ {49.999992} \
  ...
  connect_bd_intf_net -intf_net ps8_1_axi_periph_M00_AXI [get_bd_intf_pins hm2_axilite_int_0/S_AXI] [get_bd_intf_pins ps8_1_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_1_M_AXI_HPM0_FPD [get_bd_intf_pins ps8_1_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_1/M_AXI_HPM0_FPD]
  ...
  connect_bd_net -net HostMot2_ip_wrap_0_rates [get_bd_pins HostMot2_ip_wrap_0/rates] [get_bd_pins xlslice_0/Din]
  ...
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins rst_ps8_1_99M/dcm_locked]
  ...
  connect_bd_net -net rst_ps8_1_99M_peripheral_aresetn [get_bd_pins hm2_axilite_int_0/S_AXI_aresetn] [get_bd_pins ps8_1_axi_periph/ARESETN] [get_bd_pins ps8_1_axi_periph/M00_ARESETN] [get_bd_pins ps8_1_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_1_99M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_1/pl_ps_irq0]
  connect_bd_net -net xlslice_0_Dout [get_bd_ports RATES] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net zynq_ultra_ps_e_1_pl_clk0 [get_bd_pins HostMot2_ip_wrap_0/clklow] [get_bd_pins HostMot2_ip_wrap_0/clkmed] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins hm2_axilite_int_0/S_AXI_aclk] [get_bd_pins ps8_1_axi_periph/ACLK] [get_bd_pins ps8_1_axi_periph/M00_ACLK] [get_bd_pins ps8_1_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_1_99M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_1/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_1/pl_clk0]
  connect_bd_net -net zynq_ultra_ps_e_1_pl_resetn0 [get_bd_pins rst_ps8_1_99M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e_1/pl_resetn0]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_1/Data] [get_bd_addr_segs hm2_axilite_int_0/S_AXI/reg0] SEG_hm2_axilite_int_0_reg0
